...
ZJE的课程大一阶段相对固定，BMI和BMS在第二学期的课会有一节不同，就是IBI和BH。BMS专业的学生可以在第一学期报名选择下学期的IBI课 （会有统一的意向调查，在选项栏里可通过写一封你为什么要选IBI的理由为题的信进行筛选。注意，想转专业必报这门课，所以有转专业意向记得写转专业意向。）。BMI专业则不用主动报名，直接选定为IBI课程，且BMI专业无法报名BH。ZJE大一考试全以选择题形式，2022级的所有期末考试都是30道选择题。
...
多周都有实验课。注意不要缺，因为一共就十多节，随便缺一节就超过10%容易force fail。有实验本以及题目，题目踩点给分（其实是由研究生等批改）。平时有平时作业，线上，基本每天都有，比较多。
...
IBI将会以真实世界的应用程序为例，帮助了解生物信息学基本技术概念的同时，介绍生物信息学的各种技术子领域，包括基因组学、使用在线医疗资源、公共卫生信息学和人工智能。IBI帮助学生对该领域的内容有一个广泛的了解，让学生有机会在未来几年更加深入。在所有的主题领域，该课程将突出和强调共同的核心能力：汇编和评估信息、处理和分析数据、解决问题、使用可用工具、信息资料库与其标准。其中的practical课程给学生提供了练习编程技能的机会，并将它们应用于生物医学问题。practical课程使用R和python为主，且需要较强的课下自学解决问题能力。该部分成果会在学期中提交，并被算作成绩的一部分。
...
### 2025年9月份左右AA制度被取消了，所以以下部分仅保留作为制度参考（该制度在国外高校广泛应用）。

新的办事清单可参考：[本科生办事清单](https://zje.zju.edu.cn/2023/1016/c77549a2813458/page.psp)或者在该网站自行查找最新版。包括原来AA应该负责的请假，特殊情况申请等等职能。此办事清单实测2026年仍然有效，但是建议寻找最新版本。细节请问辅导员，辅导员在很多部分接手了AA的职能。
